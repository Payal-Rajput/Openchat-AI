...
const Register = () => {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      setSuccess('Registered! Check your email for OTP verification.')
    } catch (err) {
  ...
  return (
    <div className="h-[90vh] grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-6 p-6 max-w-7xl mx-auto lg:items-center">
      ...
      <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 shadow-2xl">
        ...
        {success && (
          <div className="text-green-400 text-sm mb-4 p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
            {success}
          </div>
        )}
